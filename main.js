let Money = 0; let Workers = 0; let Machine = 0; let infGrowth = 0;
...
function Display() {
	...
	infGrowth_display.textContent = iGrowth.toLocaleString('ko');
}
...
function infGrowthUpdate() { Machine = Machine + infGrowth; }

setInterval(Display, 10);
setInterval(MoneyUpdate, 100);
setInterval(EmployUpdate, 100);
setInterval(infGrowthUpdate, 100);
